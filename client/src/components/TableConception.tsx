    ...
    return (
        <>
            <div className="flex justify-center items-center">
                <div className="workspace-container flex justify-center items-center w-72 h-72">
                    <div className=" relative flex justify-center items-center w-48 h-36 bg-[#DEB887] rounded-md">
                        <button className=" top absolute  hover:bg-[#f5debf] -top-12 left-1/2 transform -translate-x-1/2">
