...
const Footer = () => {
    ...
    <div className="flex flex-col items-center md:items-start mt-20">
      ...
      <h1 className="lg:text-4xl font-bold italic sm:text-xl">RB Coworking-Space</h1>
      <p className="lg:text-xl mt-2 text-gray-300 italic text-center md:text-left sm:text-sm">
    ...
    <div className="flex flex-col items-center md:items-start mt-20 lg:block sm:hidden sm-md:hidden">
    ...
    <div className="flex flex-col items-center md:items-start mt-20 sm-md:hidden">
      <h2 className="lg:text-4xl font-semibold mb-4 italic sm:text-xl">Contact</h2>
      <div className="flex items-center space-x-2 gap-4 mt-4">
        <MapPin size={32} />
        <p className="lg:text-xl italic text-gray-300 sm:text-sm">Adresse: Rue Ennasr, Teboulba, Monastir</p>
      </div>
      <div className="flex items-center space-x-2 mt-6 gap-4">
        <Phone size={32} />
        <p className="text-xl italic text-gray-300 sm:text-sm">Téléphone: +216 51 660 551</p>
      </div>
      <div className="flex items-center space-x-2 mt-6 gap-4">
        <Mail size={32} />
        <p className="text-xl italic text-gray-300 sm:text-sm">Email: rbitsolutions55@gmail.com</p>
      </div>
    </div>
    </div>
    <div >
