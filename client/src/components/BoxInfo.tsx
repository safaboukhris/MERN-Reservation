        ...
        <div className="mb-80 flex justify-between gap-10 bg-white rounded-3xl shadow-md w-[85%] p-10 absolute -mt-14 right-[8%] ">
            <div className="flex justify-between gap-10 p-5 hover:bg-[#9fbabb] hover:text-white rounded-3xl transition">
                ...
                <div>
                    ...
                    <p className="text-gray-500 font-[YujiMai] text-xl">Chez nous, la qualité n’est pas une simple option, mais une véritable exigence. Nous nous engageons à répondre pleinement aux attentes 
            ...
            <div className="flex justify-between gap-10 p-5 hover:bg-[#9fbabb] rounded-3xl transition">
                ...
                <div>
                    <h3 className="text-gray-800 font-bold text-3xl font-[YujiMai] mb-2"> Flexibilité</h3>
                    <p className="text-gray-500 font-[YujiMai] text-xl">La flexibilité est au cœur de notre approche. Nous nous adaptons à votre mode de travail, qu’il s’agisse d’espaces partagés ou 
            ...
            <div className="flex justify-between gap-10 p-5 hover:bg-[#9fbabb] rounded-3xl transition">
                ...
                <div>
                    <h3 className="text-gray-800 font-bold text-3xl font-[YujiMai] mb-2">Communauté</h3>
                    <p className="text-gray-500 font-[YujiMai] text-xl">Travailler chez RB coworking space, c’est bien plus qu’un simple lieu de travail ! Nous favorisons le partage, stimulons la collaboration,
