...
const Home = () => {
  return (
    <>
      <div className="relative h-[800px] bg-cover bg-center" style={{ backgroundImage: "url('/cowork.jpg')" }}>
        <Header />
        <div className="absolute inset-0 flex justify-center items-center text-white">
          <div className="text-center">
            <p className="text-5xl text-gray-950 font-[YujiMai] font-bold">
              <span className="text-[#ff861a]">UN MEILLEUR ENVIRONEMENT </span> POUR TRAVAILLER
            </p>
            <p className="text-lg mt-8 font-[YujiMai] text-gray-950 font-bold">
